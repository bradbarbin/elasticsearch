(function() {
  ...
  var DEFAULT_LIST_CLASS = "stwt-url list-slug";
  // Default CSS class for auto-linked usernames (along with the url class)
  var DEFAULT_USERNAME_CLASS = "stwt-url username";
  // Default CSS class for auto-linked hashtags (along with the url class)
  var DEFAULT_HASHTAG_CLASS = "stwt-url hashtag";
  // Default CSS class for auto-linked cashtags (along with the url class)
  var DEFAULT_CASHTAG_CLASS = "stwt-url cashtag";
  ...
  twttr.txt.autoLinkEntities = function(text, entities, options) {
    ...
    options.cashtagUrlBase = options.cashtagUrlBase || "#%24";
    options.listClass = options.listClass || DEFAULT_LIST_CLASS;
    options.usernameClass = options.usernameClass || DEFAULT_USERNAME_CLASS;
    options.usernameUrlBase = options.usernameUrlBase || "#%40";
    options.listUrlBase = options.listUrlBase || "https://stocktwits.com/";
